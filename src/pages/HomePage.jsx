...
export const HomePage = () => {
  ...
  // const combinedData = [
  //   ...todaysData.map((item) => ({ ...item, category: "Todays" })),
  ...
  const filteredTodaysData = todaysData.filter((today) =>
    today.data.title.toLowerCase().includes(search.toLowerCase())
  );
